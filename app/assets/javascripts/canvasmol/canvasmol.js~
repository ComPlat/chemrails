...
// default colors
var BONDS_COLOR = [0,0,0];
var ATOMS_COLOR = [0,0,0];
...
function molecule_div(i) {
    ...
    tmp += '<canvas width="200" height="200" id="screen'+i+'"></canvas>';
    tmp += '<br class="clr"/>';
...
function toggleAtoms (div) {
    targetdiv = div;
    molecule.toggle_atoms();
    }

function toggleLetters (div) {
    targetdiv = div;
    molecule.toggle_letters();
    }
function toggle_autorotation_x (div) {
    targetdiv = div;
    molecule.toggle_autorotation_x();
    molecule.toggle_autorotation_y();
    molecule.toggle_autorotation_z();
